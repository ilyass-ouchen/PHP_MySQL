...
echo"<table><th ></th><th ></th>";
  $requete = "select Ca_id , jr_id , clubs_id , jr_nom, clubs_nom  ,début , fin  FROM Clubs NATURAL join Carriere NATURAL join Joueurs ORDER BY clubs_id , jr_id";
 ...
 echo "<tr><td > <input type=radio name=id value= $intg> </td><td>".$ligne[0]." - ".$ligne[3]."   ".$ligne[4]."   ".$ligne[5]." -->  ".$ligne[6]."</td><tr> ";
